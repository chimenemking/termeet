  ...
  <div className="bg-black"></div>
      ...
      <motion.div className="relative z-10  p-2 ">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl  text-white mx-auto  max-w-2xl pt-10 mb-10"
        >
        ...
        <motion.button
          ...
          className="  border-1  text-white rounded-md px-4 py-2 inline cursor-pointer text-4xl font-extralight transition-colors duration-300 ease-in-out hover:backdrop-blur-2xl">
          Explore Collection
        </motion.button>
      </motion.div>
    </section>
